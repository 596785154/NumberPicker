...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,
        ...
        MyNumberPicker.OnValueChangeListenerInScrolling{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        picker = (MyNumberPicker) this.findViewById(R.id.picker);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button5:
                ...
                break;
            case R.id.button6:
                startActivity(new Intent(MainActivity.this, TimerPicker.class));
                break;
            case R.id.button7:
                showNPVDialog();
                break;
    ...
    @Override
    public void onValueChangeInScrolling(MyNumberPicker picker, int oldVal, int newVal) {
